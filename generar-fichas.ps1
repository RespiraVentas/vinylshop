...
function Build-EnviosTexto {
    return @"
      <p><strong>Envíos a todo el país:</strong> lo paga el comprador y el costo depende del destino — escribinos por WhatsApp y te lo pasamos al momento. Despachamos el mismo día o el siguiente, y llega en $TRANSITO_MIN_D a $TRANSITO_MAX_D días hábiles.</p>
      <p><strong>Envíos al exterior:</strong> por DHL, a todo el mundo donde ellos lleguen. Consultanos el costo a tu país.</p>
